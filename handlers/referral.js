...
const handleInviteEarn = async (msg) => {
    try {
        ...
        // Make sure BOT_USERNAME is correct
        ...
        // Create simple working button
        const buttonText = `🔗 Share Your Referral Link`;
        
        const options = {
            reply_markup: {
                inline_keyboard: [
                    [{ text: buttonText, url: referralLink }]
                ]
            },
            parse_mode: 'Markdown'
        };
        ...
        console.log('✅ Invite & Earn message sent successfully');
